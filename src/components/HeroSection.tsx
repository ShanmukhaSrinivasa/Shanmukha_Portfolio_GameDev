    ...
    <section className="min-h-screen flex flex-col justify-center items-center relative px-6 overflow-hidden bg-[#0f172a]">
      ...
      <div className="text-center relative z-10">
        ...
        >
          Shanmukha
          <br />
          <span className="text-foreground/20">Srinivasa</span>
        </h1>
        ...
        <div className="flex flex-wrap gap-4 justify-center mt-10">
          {[
            ...
            {
              Icon: InstagramIcon,
              href: 'https://www.instagram.com/shk_shanmukha/',
              label: 'Instagram',
            },
            {
              Icon: Mail,
            ...
            {
              Icon: Twitter,
              href: 'https://x.com/Shanmukha_3445', 
              label: 'Twitter',
            },
            {
              Icon: YoutubeIcon,
              href: 'https://www.youtube.com/@shanmukha3445', 
              label: 'YouTube',
            },
            ...
            <a
              ...
              aria-label={label}
              onClick={playClick}
              className="group relative inline-flex items-center justify-center p-3 border-2 border-blue-500 bg-transparent text-blue-400 transition-all duration-300 shadow-[4px_4px_0px_0px_rgba(59,130,246,0.5)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] hover:bg-blue-600 hover:text-white"
            >
        ...
        <div className="mt-10">
          <a
            href="/Shanmukha_Srinivasa_Resume.pdf"
            download="Shanmukha_Srinivasa_Resume.pdf"
            onClick={playClick}
            className="group relative inline-flex items-center gap-2 px-8 py-4 border-2 border-blue-500 bg-blue-600 text-white text-sm font-bold tracking-[0.2em] uppercase transition-all duration-300 shadow-[8px_8px_0px_0px_rgba(59,130,246,0.4)] hover:bg-transparent hover:text-blue-400 hover:shadow-[8px_8px_0px_0px_rgba(59,130,246,1)]"
          >
      ...
      <div className="absolute bottom-10 right-6 md:right-10 z-10 hidden md:block">
        <div className="font-mono text-xs text-foreground/80 text-right leading-relaxed font-medium">
          <p>const games_built = "30+";</p>
          <p>const engines = ["Unity", "UE5"];</p>
          <p>const programming_languages = ["C#", "C++"];</p>
